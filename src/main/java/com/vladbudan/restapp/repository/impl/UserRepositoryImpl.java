...
public class UserRepositoryImpl implements UserRepository {
    ...
    Logger log = getLogger(UserRepositoryImpl.class.getName());
    ...
    public User save(User user) {
        ...
        try(Session session = HibernateConfig.getSessionFactory().openSession()) {
            ...
            throw new RepositoryException("User didn't save!");
        }
        return user;
    }
    ...
    public User update(User user) {
        ...
        try(Session session = HibernateConfig.getSessionFactory().openSession()) {
            ...
            log.info(e.getMessage());
            throw new RepositoryException("User didn't update!");
        }
        return user;
    }
    ...
    public User delete(Integer id) {
        ...
        try(Session session = HibernateConfig.getSessionFactory().openSession()) {
            ...
            log.info(e.getMessage());
            throw new RepositoryException("User didn't delete!");
        }
        return user;
    }
    ...
    public Optional<User> getById(Integer id) {
        ...
        try(Session session = HibernateConfig.getSessionFactory().openSession()) {
            ...
            log.info(e.getMessage());
            throw new RepositoryException("User didn't find by id!");
        }
    ...
    public List<User> getAllUsers() {
        ...
        try (Session session = HibernateConfig.getSessionFactory().openSession()) {
            ...
            log.info(e.getMessage());
            throw new RepositoryException("All users didn't find!");
        }
        return users;
    }
}
